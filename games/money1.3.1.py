...
positions = ['Интерн', 'Секретарь', 'Новичок', 'Джуниор', 'Опытный', 'Сениор', 'Специалист', 'Начальник', 'Владелец компании']
engPositions = ['Intern', 'Secretary', 'Newbie', 'Junior', 'Experienced', 'Senior', 'Specialist', 'Chief', 'Owner of company']
