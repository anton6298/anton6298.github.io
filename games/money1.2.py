...
adminSettings = LabelFrame(mainLobby, text = 'Прочее', width = 50, height = 50)
#Нефть
...
howManyTimeLive = Label(gameProcess, text = timeUntilDeathText)
...
helpTheCreator = Button(adminSettings, text = 'Помочь автору', command = helpCreator)
